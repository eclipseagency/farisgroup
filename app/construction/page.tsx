...
export default function ConstructionPage() {
  ...
  const content = translations[locale].pageContent.construction;

  return (
    <>
      {/* Hero */}
      <section className="relative w-full h-screen min-h-[500px] overflow-hidden flex items-center justify-center">
        <img src="https://farisgroup.net/wp-content/uploads/2023/05/DSC05991-scaled-1.jpg" alt="{content.heroTitle}" className="absolute inset-0 w-full h-full object-cover object-bottom" />
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="rounded-xl overflow-hidden shadow-2xl">
              <img src="https://farisgroup.net/wp-content/uploads/2023/06/DSC05991-scaled-1.jpg" alt="{content.title}" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
