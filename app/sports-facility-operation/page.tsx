    ...
    <>
      ...
      <section className="relative w-full h-screen min-h-[500px] overflow-hidden flex items-center justify-center">
        <img
          ...
          alt="Sports Facility Operation Hero"
      ...
      <div className="bg-gray-50 border-b border-gray-200 py-3">
        <div className="container-custom">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>/</span>
            <span className="text-gray-800 font-medium">SPORTS FACILITY OPERATION</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Operating sports facility can pose quite a challenge to some with no experience.
                Faris Group offers sports facility operation contracts to assist our clients
                especially in the early days of operation.
              </p>
            </div>
            <div className="rounded-xl overflow-hidden shadow-2xl">
              <img
                src="https://farisgroup.net/wp-content/uploads/2023/05/1232.jpg"
                alt="Sports Facility Operation"
