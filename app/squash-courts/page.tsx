...
export default function SquashCourtsPage() {
  ...
  const content = translations[locale].pageContent.squashCourts;
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img src="https://farisgroup.net/wp-content/uploads/2023/05/28058482_195341751233714_3716889217452087241_n.jpg" alt="{content.title}" className="w-full h-80 object-cover" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img src="https://farisgroup.net/wp-content/uploads/2023/05/28167927_195341747900381_7372523716644854920_n.jpg" alt="{content.title}" className="w-full h-80 object-cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {projectImages.map((src, index) => (
              <div key={index} className="overflow-hidden rounded-xl shadow-md aspect-square">
                <img src={src} alt="Squash court" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
            ))}
          </div>
        </div>
