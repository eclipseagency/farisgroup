...
export default function ClimbingWallPage() {
  ...
  const content = translations[locale].pageContent.climbingWall;
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img src="https://farisgroup.net/wp-content/uploads/2023/05/Kids-wall-climbing-MiraclZ-garden-Dubai-2.jpeg" alt="{content.title}" className="w-full h-80 object-cover" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img src="https://farisgroup.net/wp-content/uploads/2023/05/WhatsApp-Image-2020-12-23-at-9.53.49-AM-3.jpeg" alt="{content.title}" className="w-full h-80 object-cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {projectImages.map((src, index) => (
              <div key={index} className="overflow-hidden rounded-xl shadow-md aspect-square">
                <img src={src} alt="Climbing Wall project" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
            ))}
          </div>
        </div>
