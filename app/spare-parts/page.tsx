      ...
      <div className="py-3 border-b border-white/10" style={{ background: "rgba(255,255,255,0.04)" }}>
        <div className="container-custom">
          <nav className="flex items-center gap-2 text-sm text-white/50">
            ...
            <span>/</span>
            <span className="text-white/80 font-medium">SPARE PARTS</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/60 leading-relaxed">
                Available in our inventory are a number of spare parts for bowling and sports
                equipment. Some non-readily available parts can also be requested for order and
                delivery within 60-90 days upon payment confirmation.
              </p>
            </div>
            <div className="rounded-xl overflow-hidden shadow-2xl">
              <img
                src="https://farisgroup.net/wp-content/uploads/2023/05/348504027_1650644135377323_437729869112762108_n.jpg"
                alt="Spare Parts"
