...
export default function MaintenancePage() {
  ...
  const content = translations[locale].pageContent.maintenance;
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/60 leading-relaxed mb-5">{content.p1}</p>
              <p className="text-white/60 leading-relaxed">{content.p2}</p>
            </div>
            <div className="rounded-xl overflow-hidden shadow-2xl">
              <img src="https://farisgroup.net/wp-content/uploads/2023/05/cxzv.jpg" alt="{content.title}" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
