...
const projectImages = [
  ...
  "https://farisgroup.net/wp-content/uploads/2023/05/11149252_958084537570313_5781656705710785704_n.jpg",
...
export default function StrengthMachinesPage() {
  ...
  const content = translations[locale].pageContent.strengthMachines;

  return (
    <>
      <section className="relative w-full h-screen min-h-[500px] overflow-hidden flex items-center justify-center">
        <img src="https://farisgroup.net/wp-content/uploads/2023/05/20230524190633_fpdl.in_heavy-weight-lifting-equipment-standing-row-empty-gym_116547-29072_large.jpg" alt={content.heroTitle} className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="py-3 border-b border-white/10" style={{ background: "rgba(255,255,255,0.04)" }}>
        <div className="container-custom">
          <nav className="flex items-center gap-2 text-sm text-white/50">
            ...
            <span>/</span>
            <Link href="/fitness-and-gym" className="text-white/70 hover:text-gold transition-colors">{t("pages.fitnessGym.title")}</Link>
            <span>/</span>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img src="https://farisgroup.net/wp-content/uploads/2023/05/20230524190633_fpdl.in_heavy-weight-lifting-equipment-standing-row-empty-gym_116547-29072_large.jpg" alt={content.title} className="w-full h-80 object-cover" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {projectImages.map((src, index) => (
              <div key={index} className="overflow-hidden rounded-xl shadow-md aspect-square">
                <img src={src} alt="Strength machines project" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
            ))}
          </div>
        </div>
